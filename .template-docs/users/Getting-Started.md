...
When you want to pull in the latest template improvements, trigger the sync workflow manually. See the [Template Sync Guide](./Help/Template-Sync.md) for setup, usage, and troubleshooting.
